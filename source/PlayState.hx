...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['Sick!', 0.95],
		['Funkin!!', 0.975],
		['Funkin HARD!!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		watermarkTxt = new FlxText(12, healthBarBG.y + 58, FlxG.width, "Ghosted Engine 0.1 (PE 0.5.1) - " + SONG.song + ": " + storyDifficultyTxt, 14);
  ...
  public function clearShaderFromCamera(cam:String){
	...
	private function generateSong(dataPath:String):Void
	{
		...
		if (SONG.needsVoices)
			...
			vocals = new FlxSound().loadEmbedded(Paths.voices(PlayState.SONG.song, (SONG.specialAudioName == null ? CoolUtil.difficulties[storyDifficulty].toLowerCase() : SONG.specialAudioName)));
		else
			vocals = new FlxSound();
	...
	override public function update(elapsed:Float)
	{
		...
		if(!inCutscene) {
			var lerpVal:Float = CoolUtil.boundTo(elapsed * 2.4 * ClientPrefs.cameraSpeed, 0, 1);
